    ...
    <div style={{ background: "#FAFAF8", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: "780px", margin: "0 auto", padding: "100px 48px 100px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
          <a href="/signup" style={{ background: "#FF7C6F", color: "#FFFFFF", textDecoration: "none", fontWeight: "600", fontSize: "15px", padding: "14px 28px", borderRadius: "6px", fontFamily: "var(--font-sans)" }}>
            List my podcast →
          </a>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "80px 48px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px" }}>
        ...
        {/* Brands */}
        <div style={{ padding: "56px 48px", background: "#00215e", borderRadius: "12px", display: "flex", flexDirection: "column" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px, 2.5vw, 34px)", fontWeight: "700", color: "#FFFFFF", marginBottom: "20px", letterSpacing: "-0.8px", lineHeight: "1.15", fontFamily: "var(--font-display)" }}>
          ...
          <div style={{ marginTop: "auto" }}>
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 36px", display: "flex", flexDirection: "column", gap: "12px" }}>
              {["Browse and connect with any budget", "Filter by niche, size and location", "Send targeted briefs to matched shows", "Connect directly with podcasters"].map(item => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
          {[
            ...
            <div key={item.step} style={{ background: "#FFFFFF", padding: "36px", border: "1px solid #EFEFED", borderRadius: "12px" }}>
              <div style={{ fontSize: "11px", fontWeight: "700", color: "#FF7C6F", letterSpacing: "2px", marginBottom: "20px", fontFamily: "var(--font-sans)" }}>{item.step}</div>
              <h3 style={{ fontSize: "19px", fontWeight: "700", color: "#00215e", marginBottom: "12px", letterSpacing: "-0.4px", fontFamily: "var(--font-display)" }}>{item.title}</h3>
              <p style={{ fontSize: "14px", color: "#6B6B6B", lineHeight: "1.7", fontFamily: "var(--font-sans)" }}>{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ background: "#FF7C6F", padding: "80px 48px", textAlign: "center" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <a href="/signup" style={{ display: "inline-block", background: "#FFFFFF", color: "#FF7C6F", textDecoration: "none", fontWeight: "700", fontSize: "15px", padding: "14px 32px", borderRadius: "6px", fontFamily: "var(--font-sans)" }}>
