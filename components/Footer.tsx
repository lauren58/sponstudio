      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "32px" }}>
        <div>
          ...
          <p style={{ fontSize: "12px", color: "#6B6B6B", fontFamily: "var(--font-sans)", marginTop: "6px" }}>
            Built by <a href="https://centennialworld.com" style={{ color: "#6B6B6B", textDecoration: "underline" }}>Centennial World</a>
          </p>
        </div>
        <div style={{ display: "flex", gap: "48px", flexWrap: "wrap" }}>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <a href="/faq" style={{ fontSize: "13px", color: "#6B6B6B", textDecoration: "none", fontFamily: "var(--font-sans)" }}>FAQ</a>
              <a href="/terms" style={{ fontSize: "13px", color: "#6B6B6B", textDecoration: "none", fontFamily: "var(--font-sans)" }}>Terms of Service</a>
              <a href="/privacy" style={{ fontSize: "13px", color: "#6B6B6B", textDecoration: "none", fontFamily: "var(--font-sans)" }}>Privacy Policy</a>
            </div>
          </div>
        <div>
