            ...
            <a key={podcast.id} href={`/browse/${podcast.id}`} style={{ textDecoration: "none", display: "block" }}>
              ...
              >
                ...
                <div style={{ padding: "20px" }}>
                  ...
                  {podcast.description && (
                    <p style={{ fontSize: "12px", color: "#6B6B6B", fontFamily: "var(--font-sans)", marginBottom: "12px", lineHeight: "1.5", display: "-webkit-box", WebkitLineClamp: 4, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
                      {podcast.description}
                    </p>
                  )}
